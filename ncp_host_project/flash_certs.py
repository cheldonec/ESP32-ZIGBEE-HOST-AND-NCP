...
BIN_FILE = "spiffs_zbm_certs.bin"
PARTITION_NAME = "zbm_certs"
DESCRIPTION = "SSL/TLS сертификаты (MQTT, HTTPS)"
...
def main():
    print("🚀 Прошивка раздела 'zbm_certs'...\n")
    ...
    print("✅ 'zbm_certs' прошит успешно!")
