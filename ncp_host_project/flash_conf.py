...
BIN_FILE = "spiffs_zbm_conf.bin"
PARTITION_NAME = "zbm_conf"
DESCRIPTION = "Конфигурация устройства (zbm_config.json, device_index.json)"
    ...
    try:
        ...
        if match:
            ...
            if "Failed to connect" in output:
                print("⚠️  ESP32 не в режиме прошивки. Нажми BOOT + RESET.")
...
def main():
    print("🚀 Прошивка раздела 'zbm_conf'...\n")
