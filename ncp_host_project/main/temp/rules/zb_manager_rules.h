...
typedef struct {
    ...
    union {
        struct {
            ...
            uint8_t cluster_custom_cmd_id; // нестандартная команда для кластера, например туя 0xfd кнопка
            bool use_cluster_custom_cmd_id;            // true если cluster_custom_cmd_id != 0
