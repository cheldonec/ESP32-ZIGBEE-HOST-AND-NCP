// File: main/zbm_dev_base/zbm_attr_factory_basic.h
#ifndef ZBM_ATTR_FACTORY_BASIC_H
#define ZBM_ATTR_FACTORY_BASIC_H

#include "zbm_attr_types.h"
#include "zbm_clusters_type.h"

/**
 * @brief Создаёт массив стандартных атрибутов для Basic кластера
...
/**
 * @brief Создаёт массив стандартных команд для Basic кластера
 * @param[out] count Указатель, куда запишется количество атрибутов
...
#endif // ZBM_ATTR_FACTORY_BASIC_H