// File: main/zbm_dev_base/zbm_attr_factory_humidity_meas.c
...
static zbm_cluster_attribute_t* create_attr_measured_value(void) {
    return create_attr(0x0000, "Measured Value", ZBM_ATTR_TYPE_U16, sizeof(uint16_t));
}

static zbm_cluster_attribute_t* create_attr_min_measured_value(void) {
    return create_attr(0x0001, "Min Measured Value", ZBM_ATTR_TYPE_U16, sizeof(uint16_t));
}

static zbm_cluster_attribute_t* create_attr_max_measured_value(void) {
    return create_attr(0x0002, "Max Measured Value", ZBM_ATTR_TYPE_U16, sizeof(uint16_t));
}
