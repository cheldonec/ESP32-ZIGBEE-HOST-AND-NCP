...
typedef enum {
    ...
    ATTR_TEMP_MEASUREMENT_MIN_VALUE_ID     = 0x0001,  /*!< MinMeasuredValue*/
    ATTR_TEMP_MEASUREMENT_MAX_VALUE_ID     = 0x0002,  /*!< MaxMeasuredValue */
    ATTR_TEMP_MEASUREMENT_TOLERANCE_ID     = 0x0003,  /*!< Tolerance */
} zb_manager_zcl_temp_measurement_attr_t;
